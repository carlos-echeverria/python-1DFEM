...
verification("Case 1", 150, rhsfn=lambda(x):0.0*x+1.0,    exactfn=lambda(x):0.0*x+1.0)
verification("Case 2", 150, rhsfn=lambda(x):x+2.0,        exactfn=lambda(x):x)
verification("Case 3", 150, rhsfn=lambda(x):x**2+4*x+2.0, exactfn=lambda(x):x**2)
